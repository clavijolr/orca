                                        ...
                                        <div class="col-sm-6 col-12 d-flex justify-content-between flex-column text-right order-sm-2 order-1">
                                            <div class="dropdown chart-dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownItem5">
                                                    <a class="dropdown-item" href="javascript:void(0);">Ultimo 15 Dias</a>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between pb-0">
                                    <h4 class="card-title">Historico de lançamentos</h4>
                                    <div class="dropdown chart-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownItem4">
                                            <a class="dropdown-item" href="javascript:void(0);">Ultimo 15 Dias</a>
                                            <a class="dropdown-item" href="javascript:void(0);">Ultimo Mês</a>
                                            <a class="dropdown-item" href="javascript:void(0);">Ultimo Ano</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between mt-1">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <span class="font-large-1 font-weight-bold">15 dias</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
