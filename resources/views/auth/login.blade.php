                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title font-weight-bold mb-1">Bem vindo ao ORCA</h2>
                                <h4 class="card-title font-weight-bold mb-1">Seu gerenciador de orçamento familiar </h4>
                                ...
                                <form class="auth-login-form mt-2" action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="email" type="text" name="email" placeholder="jose.silva@exemplo.com.br" aria-describedby="login-email" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="form-group">
