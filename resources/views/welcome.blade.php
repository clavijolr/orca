<!DOCTYPE html>
<html class="loading" lang="ptbr" data-textdirection="ltr">
<!-- BEGIN: Head-->
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title font-weight-bold mb-1">Bem vindo ao Gerenciador de fluxo de caixa</h2>
                                
                                <p class="card-text mb-2">Entre com seus dados para acessar</p>

                                {{-- <form class="auth-login-form mt-2" action="{{ url('dashboard')}}" method="POST"> --}}
                                    ...
                                    <a href="{{ url('dashboard')}}"class="btn btn-primary btn-block" tabindex="4">Entrar</a>
                                {{-- </form> --}}
                            </div>
                        </div>
                        <!-- /Login-->
